...
| 依赖管理 | venv + requirements.txt | 最容易复现，README 三步可跑；可补充 uv 加速安装，但不是主路径。 |
...
| Reranker | BAAI/bge-reranker-v2-m3 | CrossEncoder 对召回候选重排，提升 precision；eval 展示加/不加 reranker 的 top-k 对比。 |
